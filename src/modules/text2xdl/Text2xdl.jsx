...
export const Text2xdlFeature = () => {
  ...
  return (
    <div className="searchEngine-xdl">
      ...
      {/* {copySuccess} */}
      <TextField sx={{"width": "32.5%", "background": "#fff"}} id="outlined-select-currency" select label="Select a Text" value={selectedDrug} onChange={handleDrugChange}>
        {
